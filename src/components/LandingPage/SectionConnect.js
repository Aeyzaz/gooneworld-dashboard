            ...
            <Fragment>
                <Row>
                    <Colxx xxs={{ size: "12", offset: 0 }} lg={{ size: 8, offset: 2 }} className="text-center">
                        ...
                        <p>
                            <IntlMessages id="To receive our newsletter please complete the form above. We take your privacy seriously and we will not share your information with others. You can unsubscribe at any time." />
                        </p>
                    </Colxx>
                </Row>
