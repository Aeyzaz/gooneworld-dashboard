...
export default class SectionFeatures2 extends React.Component {
    render() {
        return (
            <Fragment>
                <Row>
                    ...
                    <Colxx xxs="12" md="6" lg="5" className="d-flex align-items-center">
                        <div className="d-flex">
                            <div className="feature-text-container">
                                <h2><IntlMessages id="lp.featuressection_2.title-1"/></h2>
                                <p>
                                    <IntlMessages id="lp.featuressection_2.detail-1-1"/><br/><br/>
                                    <IntlMessages id="lp.featuressection_2.detail-1-2"/><br/><br/>
                                    <IntlMessages id="lp.featuressection_2.detail-1-3"/>
                                </p>
                            </div>
                        </div>
                    </Colxx>
