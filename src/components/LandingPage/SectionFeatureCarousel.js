                            ...
                            <Card>
                                <CardBody className="text-center">
                                    <div>
                                        ...
                                        <h5 className="mb-0 font-weight-semibold"><IntlMessages id="Commercial Loans"/></h5>
                                    </div>
                                    <div>
                                        <p className="detail-text">
                                        <IntlMessages id="Acquisitions"/>
                                        <br/>
                                        <IntlMessages id="Refinance"/>
                                        <br/>
                                        <IntlMessages id="Cash Out"/>
                                        </p>
                                    </div>
                            ...
                            <Card>
                                <CardBody className="text-center">
                                    ...
                                    <div>
                                        ...
                                        <IntlMessages id="lp.featurecarousel.detail-2.1"/>
                                        </p>
                                    </div>
                                    <NavLink className="btn btn-link font-weight-semibold" to="/features2"><IntlMessages id="lp.featurecarousel.view"/></NavLink>
                                </CardBody>
                            </Card>
                        </div>
                        <div className="pr-3 pl-3">
                            <Card>
                                <CardBody className="text-center">
                                    ...
                                    <NavLink className="btn btn-link font-weight-semibold" to="/features3"><IntlMessages id="lp.featurecarousel.view"/></NavLink>
                                </CardBody>
                            </Card>
                        </div>
