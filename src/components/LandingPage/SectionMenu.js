    ...
    return (
      <Container className="d-flex align-items-center justify-content-between">
        ...
        <Nav className="navbar-nav d-none d-lg-flex flex-row">
          <NavItem className={window.location.pathname === '/singlepage-home' ? 'active' : ''}>
        ...
        <Nav className="navbar-nav d-none d-lg-flex flex-row">
          ...
          <NavItem>
            <NavLink
              to="contact"
              onClick={event => {
                this.props.onClick("contact", event);
              }}
            >
              <IntlMessages id="lp.menu.contact" />
            </NavLink>
          ...
          <NavItem>
            <NavLink
              to="about"
              onClick={event => {
                this.props.onClick("about", event);
              }}
            >
              <IntlMessages id="lp.menu.about" />
            </NavLink>
