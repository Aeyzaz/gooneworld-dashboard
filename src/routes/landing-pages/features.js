          ...
          <div className="main-container">
            ...
            <div className="content-container" ref={(x) => { this.home = x; }}>
              <div className="section home subpage">
                <Container>
                  <SubHero title="Commercial Real Estate Financing" detail="Commercial real estate financing can be a complicated process without a lender expert, who understand your needs and are able to help you accomplish your plans. The lending officers at KlickMortgage have the experience needed to structure loans that fit your business needs."/>
                  <Row>
