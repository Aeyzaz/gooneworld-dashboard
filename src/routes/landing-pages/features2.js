...
import FeaturesSection from "Components/LandingPage/SectionFeatures2";
import FeaturesIcons from "Components/LandingPage/SectionFeaturesIcons2";
          ...
          <div className="main-container">
            ...
            <div className="content-container" ref={(x) => { this.home = x; }}>
              <div className="section home subpage">
                <Container>
                  <SubHero title="test2" detail={messages["lp.features.detail"] }/>
                  <Row>
...
export default connect(mapStateToProps, {landingPageMobileMenuToggle,landingPageMobileMenuClose})(injectIntl(Features2))