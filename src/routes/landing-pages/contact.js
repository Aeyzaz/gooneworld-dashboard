        ...
        <div className={this.props.isMobileMenuOpen ? "landing-page show-mobile-menu" : "landing-page"}>
          ...
          <div className="main-container">
            ...
            <div className="content-container" ref={(x) => { this.home = x; }}>
                    ...
                    <Colxx xxs="12" xl="5" lg="12">
                        <div className="home-text">
                            ...
                            <p className="white mb-3">
                                We always ready to answer your loan inquiries anytime,
                            </p>
                            <p className="white mb-3">
                                and give you our best loan scenarios
                            </p>
                            {this.props.children}
                        </div>
                    </Colxx>
                ...
                <Container>
                  <Row>
                    ...
                    <Colxx xxs="12" lg={{ size: 4, offset: 1 }} className="side-bar">
                      ...
                      <p className="mb-5">429 Lenox Ave Suite 433 <br/>Miami Beach Fl 33139</p>

                      <p className="text-primary mb-2">Phone</p>
                      <p className="mb-0">305.420.6679</p>
              ...
              <div className="section background background-no-bottom mb-0" style={{'paddingBottom':0,'paddingTop':0}}>
                <Container>
                  <SectionConnect />
                </Container>
              </div>
