...
import FeaturesSection from "Components/LandingPage/SectionFeatures3";
import FeaturesIcons from "Components/LandingPage/SectionFeaturesIcons3";
          ...
          <div className="main-container">
            ...
            <div className="content-container" ref={(x) => { this.home = x; }}>
              <div className="section home subpage">
                <Container>
                  <SubHero title="test3" detail={messages["lp.features.detail"] }/>
                  <Row>
...
export default connect(mapStateToProps, {landingPageMobileMenuToggle,landingPageMobileMenuClose})(injectIntl(Features3))