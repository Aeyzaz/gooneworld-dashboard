...
class Favorites extends Component {
    constructor(props) {
      ...
      this.state = {
        ...
        orderOptions:[
          {column: "id",label: "idFavorite"}],
        selectedOrderOption:  {column: "id",label: "idFavorite"},
    ...
    dataListRender() {
      ...
      var contador = 0;
        ...
        axios.get(apiUrl_Goone+'/api/Users/'+iduser+'/favorites')
          ...
          this.setState({
            totalPage : Math.ceil(contador/selectedPageSize),
            totalItemCount : contador
          });

    }

    handleDeleteFavorite = (id,matrixid) => {
      ...
      const API_URL = apiUrl_Goone+'/api/Users/'+iduser+'/favorites/remove/'+matrixid;
            ...
            <Row>
              {this.state.items.map(product => {
                if (this.state.displayMode === "imagelist") {
                  ...
                  var typelink = "https://goonew.herokuapp.com/listings/details/"+product.City+"/"+product.StateOrProvince+"/"+typetrans+"/"+product.Slug+"/"+product.ListingKeyNumeric;
                      ...
                      >
                        ...
                        >
                          <div className="position-relative">
                            ...
                            >*/}
                            <a href={typelink} className="w-40 w-sm-100" target="_blank">
                              <CardImg
                                top
                          ...
                          <CardBody>
                            <Row>
                              ...
                              <Colxx xxs="12" className="mb-3">
                                <CardSubtitle>{product.UnparsedAddress}</CardSubtitle>
                              ...
                              <Colxx xss="12">
                                <Button color="danger" className="default mb-2" onClick={() => this.handleDeleteFavorite(product.id,product.ListingKeyNumeric)}>
                  ...
                  return (
                    <Colxx xxs="12" key={product.id} className="mb-3">
                      ...
                      >
                        ...
                        >
                        {/*src='http://www.esmeth.com/wp-content/uploads/2014/11/coming_soon_thumb.png'*/}
                          {/*<NavLink
                            to={typelink}
                            className="d-flex"
                          >*/}
                          ...
                          <div className="pl-2 d-flex flex-grow-1 min-width-zero">
                            <div className="card-body align-self-center d-flex flex-column flex-lg-row justify-content-between min-width-zero align-items-lg-center">
                              ...
                              <div className="w-15 w-sm-100">
                                <Badge color={product.StandardStatus == "Active" ? "success" : "danger"} pill>
                                  {product.StandardStatus == "Active" ? "Active" : ""}
                                </Badge>
                              </div>
                            </div>
  ...
  export default injectIntl(mouseTrap(Favorites))
