...
class SavedSearch extends Component {
    constructor(props) {
      ...
      this.state = {
        ...
        selectedOrderOption:  {column: "address",label: "Address"},
    ...
    handleDeleteSearch = (id) => {
      ...
      const API_URL = apiUrl_Goone+'/api/userSearchData/'+id;
          ...
          <div className="disable-text-selection">
            <Row>
              <Colxx xxs="12">
                <div className="mb-2">
                  <h1>
                    <IntlMessages id="Saved Search List" />
                  </h1>
            ...
            <Row>
              {this.state.items.map(product => {
                  ...
                  //{"userId":"5d5c15263ad7a07791b9ef04","hostApp":"GOW","City":"Miami","State":"FL","PostalCode":"33141","PropertyTypes": ["Residential"]}
                  
                  //alert(product.PropertyTypes[0]);
                        ...
                        >
                          <div className="pl-2 d-flex flex-grow-1 min-width-zero">
                            <div className="card-body align-self-center d-flex flex-column flex-lg-row justify-content-between min-width-zero align-items-lg-center">
                              {/*<NavLink
                                to={link_saved_search}
                                className="w-40 w-sm-100"
                              >*/}
                              <a href={link_saved_search} target="_blank">
                                <p className="list-item-heading mb-1 truncate">
                                  Search For {product.TransactionType} in {product.City} - {product.StateOrProvince} - {product.PropertySubType}
                                </p>
                              </a>
                              {/*</NavLink>*/}
                            </div>
                            <div className="custom-control custom-checkbox pl-1 align-self-center pr-4">
                              <div className="custom-control custom-checkbox pl-1 align-self-center pr-4">
                              <Button color="danger" className="default mb-2" onClick={() => this.handleDeleteSearch(product.id)}>
  ...
  export default injectIntl(mouseTrap(SavedSearch))
