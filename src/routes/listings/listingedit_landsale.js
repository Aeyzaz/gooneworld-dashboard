...
class ListingEdit_Res extends Component {
  ...
  handleChecked_shortsale = (e) => {
    ...
    if(!e.target.checked){
      ...
      this.setState({
        isChecked_short_sale: true,
        checked_short_sale: "checked",
        short_sale: "on"
      });
    }
  }
  ...
  getListingData(idlisting){
    ...
    axios.get(API_URL,query)
        ...
        if(this.state.items.short_sale == "on"){
          console.log('is "on" reo');
          this.setState({isChecked_short_sale: true, checked_short_sale: 'checked', short_sale: 'on'});
        }else{
          this.setState({isChecked_short_sale: false, checked_short_sale: '', short_sale: '0'});
        }
      ...
      <Fragment>
        <Row>
          <Colxx xxs="12">
            ...
            />*/}
            <h1>
              {/*<IntlMessages id="Edit Listing Land for Sale" />*/}
              Edit Listing Land for Sale
            </h1>
              ...
              <CardBody>
                <Form name="frm_listing" id="frm_listing">  
                  ...
                  <FormGroup row>
                    ...
                    <Input type="hidden" name="typeofproperty" id="typeofproperty" value="Land"/>
                        ...
                        <Colxx sm={4}>
                          <FormGroup check>
                            <Label check>
                              ...
                              <Input type="checkbox" name="short_sale" checked={this.state.checked_short_sale} value={this.state.short_sale} onChange={this.handleChecked_short_sale}/> Short Sale
                            </Label>
                          </FormGroup>
                        </Colxx>
                    </Colxx>
