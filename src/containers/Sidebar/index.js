          ...
          <div className="scroll">
            ...
            >
              <Nav vertical className="list-unstyled">
                ...
                <NavItem
                  className={classnames({
                    active: ((this.state.selectedParentMenu == "favorites" && this.state.viewingParentMenu=="" ) || this.state.viewingParentMenu=="favorites")
                  })}
                >
                  <NavLink
                    to="/app/favorites"
                ...
                <NavItem
                  className={classnames({
                    active: ((this.state.selectedParentMenu == "savedsearch" && this.state.viewingParentMenu=="" ) || this.state.viewingParentMenu=="savedsearch")
                  })}
                >
                  <NavLink
                    to="/app/savedsearch"
        ...
        <div className="sub-menu">
          <div className="scroll">
            ...
            >
              ...
              <Nav
                className={classnames({
                  "d-block": ((this.state.selectedParentMenu == "listings" && this.state.viewingParentMenu=="" )|| this.state.viewingParentMenu=="listings")
                })}
              ...
              >
                ...
                <NavItem>
                  <NavLink to="/app/listings/listingadd_imp">
                    <i className="simple-icon-briefcase" />{" "}
                    <IntlMessages id="Add Listing Improved Commercial/Industrial" />
                  </NavLink>
                </NavItem>
                <NavItem>
                  <NavLink to="/app/listings/listingadd_buss">
                    <i className="simple-icon-briefcase" />{" "}
                    <IntlMessages id="Add Listing Business Opportunity" />
                  </NavLink>
                </NavItem>*/}
                <NavItem>
              ...
              <Nav
                className={classnames({
                  "d-block": ((this.state.selectedParentMenu == "favorites" && this.state.viewingParentMenu=="" )|| this.state.viewingParentMenu=="favorites")
                })}
                data-parent="favorites"
              >
                <NavItem>
              ...
              <Nav
                className={classnames({
                  "d-block": ((this.state.selectedParentMenu == "savedsearch" && this.state.viewingParentMenu=="" )|| this.state.viewingParentMenu=="savedsearch")
                })}
                data-parent="savedsearch"
              >
                <NavItem>
